use std::{net::Ipv4Addr, io::Cursor};

use bytes::Buf;

use super::{reply_field::ReplyField, version::SocksVersion, addr_type::AddrType, WithIpv4Addr, WithPort, error::{HandshakeError}};
...
impl SocksReply {
  pub fn new(version: SocksVersion, rep: ReplyField, atyp: AddrType, addr: Ipv4Addr, port: u16) -> Self {
    Self { version, rep, atyp, bnd_addr: addr, bnd_port: port}
  }
